...
export default function PublicProfilePage(){
  ...
  async function toggleFriend(){
    try{
      ...
      if(res.ok){ setIsFriend(Boolean(j.added)) }
    }catch(e){}
  }
          ...
          <div style={{display:'flex',gap:24,alignItems:'center'}}>
            ...
            <div style={{flex:1}}>
              ...
              <div style={{display:'flex',gap:32,marginTop:14,color:'var(--muted)'}}>
                <div style={{textAlign:'center'}}><div style={{fontWeight:800}}>{posts.length}</div><div style={{fontSize:12}}>Posts</div></div>
                <div style={{textAlign:'center'}}><div style={{fontWeight:800}}>—</div><div style={{fontSize:12}}>Likes</div></div>
                <div style={{textAlign:'center'}}><div style={{fontWeight:800}}>—</div><div style={{fontSize:12}}>Friends</div></div>
              </div>
