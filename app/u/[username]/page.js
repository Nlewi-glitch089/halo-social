          ...
          <div style={{display:'flex',gap:24,alignItems:'center'}}>
            ...
            <div style={{flex:1}}>
              ...
              <div style={{display:'flex',gap:32,marginTop:14,color:'var(--muted)'}}>
                <div style={{textAlign:'center'}}><div style={{fontWeight:800}}>{(counts && typeof counts.posts === 'number') ? counts.posts : posts.length}</div><div style={{fontSize:12}}>Posts</div></div>
                <div style={{textAlign:'center'}}><div style={{fontWeight:800}}>{(counts && typeof counts.likes === 'number') ? counts.likes : 0}</div><div style={{fontSize:12}}>Likes</div></div>
                <div style={{textAlign:'center'}}><div style={{fontWeight:800}}>{(counts && typeof counts.friends === 'number') ? counts.friends : 0}</div><div style={{fontSize:12}}>Friends</div></div>
              </div>
